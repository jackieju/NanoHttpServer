...
CLIB_OBJ = clib/exp.o clib/thread.o clib/log.o clib/utility.o os/os.o os/LogCache.o os/ostime.o os/socket.o os/str.o os/thread-pthread.o os/osutils.o os/log.o os/CSS_LOCKEX.o os/ConfigFile.o os/protected.o os/mutex.o os/LogLevel.o 
OBJ = $(CLIB_OBJ) main.o AbstractServer.o 
EXEC_OBJ  =  $(OBJ) 
...
all: all-before $(BIN_EXEC) all-after
